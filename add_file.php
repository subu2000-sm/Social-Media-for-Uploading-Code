...
$sql = "INSERT into code(pid,file) VALUES('$id','$uploads_dir')";
...
<div class="container-fluid my-3 ">
       ...
       <div class="post">
       <h1>Add Your Project Snapshot and Code</h1><br>
       ...
       <label> Snapshot Previews</label>
        <?php
            ...
            while($rows=mysqli_fetch_array($res))
            {
                ...
                <button class ='btn btn-danger' type="submit" name="del">Delete</button><br><br>
                </form>
                <?php
